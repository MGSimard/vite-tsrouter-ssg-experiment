...
import { type ChartConfig, ChartContainer, ChartTooltip, ChartTooltipContent } from "@/_components/ui/chart";

export function SectionFeatures() {
  return (
    <section>
      <div className="mx-auto grid max-w-5xl border md:grid-cols-2 px-6 pt-16 md:pt-32">
        <div>
